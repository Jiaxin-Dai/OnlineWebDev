...
public class MongoDBUtilities {
    ...
    public static DBCollection getConnection() {
        try {
            ...
            DB db = mongo.getDB("CSP584Project");
    ...
    public static String insertReview(String productname, String username, String producttype, String productmaker,
            ...
            String retailercity, String storeName, String retailerState, String onSale, String rebate, String age,
        ...
        try {
            ...
            BasicDBObject doc = new BasicDBObject("title", "myReviews").append("userName", username)
                    ...
                    .append("storeName", storeName).append("retailerState", retailerState).append("onSale", onSale)
                    .append("rebate", rebate).append("age", age).append("gender", gender)
                    .append("occupation", occupation).append("price", (int) Double.parseDouble(price));
        ...
        try {
            ...
            while (cursor.hasNext()) {
                ...
                Review review = new Review(obj.getString("productName"), obj.getString("userName"),
                        ...
                        obj.getString("price"), obj.getString("retailercity"), obj.getString("storeName"),
                        obj.getString("retailerState"), obj.getString("onSale"), obj.getString("rebate"),
                        obj.getString("age"), obj.getString("gender"), obj.getString("occupation"));
    ...
    // DBObject groupFields = new BasicDBObject("_id", new
    // BasicDBObject(dbObjIdMap));
